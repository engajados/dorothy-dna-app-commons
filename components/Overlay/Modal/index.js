...
export default function Modal({ children, size, title, actionlabel, sidebar, contentpadding, modalState, onModalChange }) {
    ...
    <div className={`${styles.modal} ${styles[state]}`}>
      ...
      <div className={`${styles.dialog}  ${styles[size]}`}>
        <div className={`${styles.header}`}>
          <div className={`${styles.title}`}><Text2>{title}</Text2></div>
          <div className={`${styles.close}`} onClick={() => handleCloseModal()}><Close/></div>
        </div>
        ...
        <div className={`${styles.footer}`}>
          ...
          <div className={`${styles.actions}`}>
            ...
            <Button variant="link" onClick={() => handleCloseModal()}>Cancelar</Button>
